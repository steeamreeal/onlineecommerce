...
const lojaSchema = z.object({
  ...
  dominioProprio: z.string().optional(),
});
...
export function LojaForm() {
  const form = useForm<LojaFormValues>({
    ...
    defaultValues: {
      ...
      dominioProprio: configuracaoLojaMock.dominioProprio ?? "",
    },
  });
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-8">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>plataforma.com/loja/{field.value || "minha-loja"}</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="www.minhaloja.com.br" {...field} />
                  </FormControl>
        ...
        <section className="flex flex-col gap-4">
          <h2 className="text-lg font-medium">Endereço, horário e políticas</h2>
          <FormField
            control={form.control}
            name="endereco"
            render={({ field }) => (
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea rows={4} placeholder="Trocas, devoluções, garantia..." {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
        ...
        <section className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            {configuracaoLojaMock.banners.map((banner) => (
              <div key={banner.id} className="bg-muted flex aspect-video items-center justify-center rounded-lg border">
